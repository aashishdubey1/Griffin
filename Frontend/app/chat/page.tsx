...
export default function ChatPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        type: "assistant",
        content:
          "I'm Griffin, your AI code review assistant. I can help you analyze code for security vulnerabilities, best practices, and optimization opportunities. Please share your code and I'll provide detailed feedback.",
        timestamp: new Date(),
      }
  ...
  return (
    ...
    >
      ...
      {/* Main Chat Container */}
      <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] mx-auto relative h-[calc(100vh-84px)]">
        {/* Side borders */}
        <div
