        ...
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-1/2 bg-gradient-to-br from-[#FFB5A7] via-[#FCD5CE] to-[#F8AD9D] p-8 lg:p-12 flex flex-col justify-between animate-in slide-in-from-left duration-700">
            <div className="flex items-center">
              <div className="w-6 h-6 bg-black rounded mr-3" aria-hidden="true"></div>
              <Link
                href="/"
            ...
            <div className="w-full max-w-md space-y-6">
              <div className="text-center space-y-2 animate-in fade-in duration-700 delay-200">
                <div className="flex justify-center mb-4">
                  <div className="text-orange-500 text-2xl animate-pulse" aria-hidden="true">
                    ✱
                  </div>
                </div>
              ...
              <form className="space-y-4 animate-in fade-in duration-700 delay-300" onSubmit={handleSubmit} noValidate>
                <div>
