      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">{"Lorem"}</div>
          </div>
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <div className="w-full h-full relative">
            <div className="absolute inset-0 flex items-center justify-center z-10">
              <div className="flex items-center gap-3 px-4 py-1 bg-white/80 backdrop-blur-sm rounded-full border border-[rgba(55,50,47,0.12)] shadow-sm">
                <span className="text-[#49423D] text-sm font-medium font-sans">Aman</span>
                <span className="text-[rgba(73,66,61,0.70)] text-xs font-normal font-sans">Aman has made this.</span>
              </div>
            </div>
